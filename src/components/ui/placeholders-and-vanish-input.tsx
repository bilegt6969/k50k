...
export function PlaceholdersAndVanishInput({
  ...
  return (
    <form
      className={cn(
        'w-full relative border border-neutral-700 max-w-xl mx-auto bg-neutral-900 dark:bg-zinc-800 h-12 rounded-full overflow-hidden shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),_0px_1px_0px_0px_rgba(25,28,33,0.02),_0px_0px_0px_1px_rgba(25,28,33,0.08)] transition duration-200',
        ...
        <AnimatePresence mode="wait">
          {!value && (
            <motion.p
              ...
              className="dark:text-zinc-900 text-sm sm:text-base font-normal text-neutral-500 pl-4 sm:pl-12 text-left w-[calc(100%-2rem)] truncate"
            >
